...
def create_instance(c_instance):
    return MiniLab_3(Specification, c_instance=c_instance) # crashes (138 in control_surface.py)
...
class MiniLab_3(ControlSurface):
    ...
    def setup(self):
        super().setup()
        AnalogLabComponent()
        display = DisplayComponent(self._identification, self.component_map['Transport']) # this crashes
